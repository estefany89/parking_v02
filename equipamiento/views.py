...
class EquiparArma(View):
   ...
   def post(self, request):
       ...
       base_url = reverse('equipamiento:equipar_arma')
       return redirect(f"{base_url}?personaje={personaje_id}")
...
class EquiparArmadura(View):
   ...
   def post(self, request):
       ...
       # Redirect con el personaje preseleccionado
       url_base = reverse('equipamiento:equipar_armadura')
       return redirect(f"{url_base}?personaje={personaje_id}")
